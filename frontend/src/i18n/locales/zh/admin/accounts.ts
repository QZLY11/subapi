export default {
    accounts: {
      ...
      workbuddyCredits: {
        ...
        checkin: '签到',
        checkinAll: '一键全部签到',
        checkinAllRunning: '正在签到…',
        checkinTooltip: '调用 CodeBuddy 每日签到接口；今日已签到会被上游幂等拒绝，视为正常',
        summaryTitle: 'WorkBuddy 总览',
        accountCount: '账号总数',
        totalSize: '总计分额度',
        totalRemain: '剩余总积分',
        todayCheckin: '今日已签到',
        ...
        statusAlready: '今日已签到',
        statusFail: '签到失败',
        checkinDone: '签到完成：成功 {ok} · 已签 {already} · 失败 {fail} · 跳过 {skipped}',
        summaryFailed: '总览刷新失败：{error}',
        queryFailed: '查询积分失败',
        checkinFailed: '签到失败',
        remainOfTotal: '剩余 {remain} / 共 {size}',
        percentRemain: '剩余 {percent}%',
      },
      opencodeGo: {
        accountMode: {
          zen: 'Zen',
