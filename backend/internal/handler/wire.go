...
func ProvideAdminHandlers(
	...
	// 让通用账号刷新端点（/admin/accounts/:id/refresh、batch-refresh）支持
	// workbuddy_oauth 账号，与后台 TokenRefreshService 走同一条刷新实现。
	accountHandler.SetWorkBuddyOAuthService(workbuddyOAuthService)
